        ...
        <div className="uploads__desktop__container">
          ...
          <div>
           <div>
             ...
             <input className="uploads__comment__box" type="text" placeholder= "Add a title to your video..." ></input> 
           </div>

           <div>
             <label className="uploads__label__description">ADD A VIDEO DESCRIPTION</label>
             <input className="uploads__comment__box__description" type="text" placeholder= "Add a description to your video..." ></input>
            </div>
         </div>
         </div>
